...
function createDataForCerts(title, icon, issueDate, expirationDate, credentialLinkl, types, level){
  return {title, icon, issueDate, expirationDate, credentialLinkl, types, level}
}
