    ...
    <Stack spacing={2}>
      ...
      <div>
        <Typography variant="body1">
          <b>Private Tutor Plus</b> is an online application for tutors to manage their businese, for example, the class schedule, students, and payments.
        </Typography>
        <Typography variant="body1">
      ...
      <div>
        <Typography variant="body1">
          The idea of <b>Private Tutor Plus</b> comes with a family member who works as a full time private tutor with over 20 students. The overwhelming students make the management of student's progress, lesson schedule, payments, and other business difficult.
        </Typography>
        <Typography variant="body1">
          In additional, in the market, there are few application dedicated for the private tutors to manage their businese, while most of the applications are tirgetd to the tutoring companies.
        </Typography>
        <Typography variant="body1">
