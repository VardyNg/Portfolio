...
/*
        ...
        class ShoppingCart extends Phaser.Scene {
            ...
            preload() {
                ...
                gameItems.push(
                               [1 ,1,"Anti-WannaCry",       300, "Solve WannaCry for once!", 1],
                               [2 ,1,"Auto Update",         700, "No more update alert!",    1],
                               [3 ,3,"Auto Routing",        1300, "Automate routing process", 1],
                               [4 ,4,"Twisted Pair Cable",  600,"Anti-EMF Wave",                         1],
                               [5 ,4,"Mouse Trap",          600,"No more mice!",                         1],
                               [6 ,1,"BlueDeath Solver",    1300,"Solve Blue Death error!",  1],
                               [7 ,1,"WannaLaugh",          1500,"No more WannaCry!,",       1],
