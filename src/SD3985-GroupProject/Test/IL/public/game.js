        ...
        */
        ...
        class SceneNetworkAccessLayer extends Phaser.Scene {
            ...
            create() {
                ...
                //     for (let j = 0; j < 3; j++)
                //     {
                //         let spriteName2 = "h" + i + j;
                //         if (i == 0)
                //             makeButton.call(this, spriteName2, 350 + i* 85, 450 + j* 70, 'packets');
                //         else
                //             makeButton.call(this, spriteName2, 350 + i* 85, 450 + j* 70, 'pipe');
                //     }
                // }
                ...
                //     var boom = this.add.sprite(x, y, 'packet', 23);

                //     boom.anims.delayedPlay(Math.random() * 3, 'packet');
                // }
                //makeButton.call(this, 'hi', 520, 300, 'pipe');

                // Create the template
                var jlength = 10;
                var count = 0;
                makeButton.call(this, "PCA", )
                for (let i = 0; i < 6; i++)
                {
                    ...
                    for (let j = 0; j < jlength; j++)
                    {
                        ...
                        {
                            if (j == 0)
                                makeButton.call(this, "PC" + count, 400 + j*60 - 60, 480 + i*50 + 30, 'computer');
                            if (j == jlength - 1)
                                makeButton.call(this, "PC" + count, 400 + j*60 + 60, 480 + i*50 + 30, 'computer');
                            if (random_boolean)
                            {
                                let spriteName2 = "mouse"+ count;
                                mouse.push(makeButton.call(this, spriteName2, 400 + j*60, 480 + i*50, 'mouse'));
                                tubes.push(makeButton.call(this, spriteName,  400 + j*60, 520 + i*50, 'brokenpipe'));
                                boom.push(this.add.sprite(400 + j*60, 520 + i*50, 'packet', 23));
                            ...
                            else
                            {
                                ...
                                tubes.push(makeButton.call(this, spriteName,  400 + j*60, 520 + i*50, 'pipe'));
                                //var boom = this.add.sprite(400 + j*60, 520 + i*50, 'packet', 23);
                                boom.push(this.add.sprite(400 + j*60, 520 + i*50, 'packet', 23));
                                boom[count].anims.delayedPlay(Math.random() * 3, 'packet');
                                count++;
                            }
                ...
                // {
                //     let random_boolean = Math.random() >= 0.4;
                //     let spriteName = "test"+ i;
                //     if (random_boolean)
                //     {
                //         let spriteName2 = "mouse"+ i;
                //         mouse.push(makeButton.call(this, spriteName2, 400 + i*60, 480, 'mouse'));
                //         tubes.push(makeButton.call(this, spriteName,  400 + i*60, 520, 'brokenpipe'));
                //     }
                //     else
                //         tubes.push(makeButton.call(this, spriteName,  400 + i*60, 520, 'pipe'));
                // }
                ...
                this.input.on('gameobjectdown', function (pointer, button)
                {
                    ...
                    if (matchStringMouse(button.name))
                    {
                        ...
                        if (button.name.slice(button.name.length - 2) > 0)
                        {
                            ...
                            // var boom = this.add.sprite(tubes[button.name.slice(button.name.length - 2)].x, tubes[button.name.slice(button.name.length - 2)].y, 'packet', 23);
                            // boom.anims.delayedPlay(Math.random() * 3, 'packet');
                        ...
                        else
                        {
                            ...
                            // var boom = this.add.sprite(tubes[button.name.slice(button.name.length - 1)].x, tubes[button.name.slice(button.name.length - 1)].y, 'packet', 23);
                            // boom.anims.delayedPlay(Math.random() * 3, 'packet');
